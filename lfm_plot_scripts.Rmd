...
```{r import data}
LFM_raw <- read.csv('~/jr_sbbg_projects/2_rwmp/lfmm/LFM_PaintedCave_jr.csv') %>%


LFM_raw <- read.csv ("C:/Users/jrenteria/OneDrive - Santa Barbara Botanic Garden/jr_sbbg_projects/2_rwmp/lfmm/LFM_PaintedCave_jr.csv") %>%
  mutate(LFM = LFM*100,
